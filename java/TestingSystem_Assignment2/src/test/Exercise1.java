...
public class Exercise1 {
	public static void main(String[] args) {
		 ...
		 */
//		if(dung.department == null)
//		{
//			System.out.println("nhan vien nay chua co phong ban");
//		}
//		else 
//		{
//			System.out.println("Phong ban cua nhan vien nay la" + " "+ dung.department.departmentName);
//			
//		}}
		/*
		 * Question 2: Kiểm tra account thứ 2,Nếu không có group thì sẽ in ra text
		 * "Nhân viên này chưa cgrou" Nếu có mặt trong 1 hoặc 2 group thì sẽ in ra text
		 * "Group của nhân viên này là Java Fresher, C# Fresher" Nếu có mặt trong 3
		 * Group thì sẽ in ra text
		 * "Nhân viên này là người quan trọng, tham gia nhiều group" Nếu có mặt trong 4
		 * group trở lên thì sẽ in ra text "Nhân viên này là người hóng chuyện, tham gia
		 * tất cả các group}
		 */
//		if(dung.groups == null)
//		{
...
//		}
//		else if (dung.groups.length ==1 || dung.groups.length == 2) {
//			for (Group groups : dung.groups ) {
//				System.out.println("group cua nhan vien nay la" + " " +groups.groupName);
//			}
//		}
//		else if (dung.groups.length == 3)
//		{
//			System.out.println("nhan vien nay la nguoi quan trong");
//			}
//		else if (dung.groups.length == 4) {
//		
//			System.out.println("Group của nhân viên này là nguoi hong chuyen");
//		}
		/* Question 3: Sử dụng toán tử ternary để làm Question 1 */
//		System.out.println(dung.department == null ? "Nhân viên này chưa có phòng ban"
//				: "Phong ban cua nhan vien nay la" + " " + dung.department.departmentName);
		...
		Developer"*/
//		System.out.println(nam.position.positionName == PositionName.DEV ?  "Đây là Developer" : "Người này không phải là Developer");
...
//		System.out.println(nam.createDate);
//		Locale locale = new Locale("vi", "VN");
//		DateFormat dateFormat = DateFormat.getDateInstance(DateFormat.DEFAULT,locale);
//		String date = dateFormat.format(nam.createDate);
...
//		String date = dateFormat.format(accounts[i].joinDate);
//		System.out.println(date);
//	}
}}
