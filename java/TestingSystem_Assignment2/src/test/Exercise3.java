...
//		Department[] departments = {sale,marketting,it,security};
...
//		for (int i =0 ; i < x;i++)
//		{
//			System.out.println("thong tin cau account thu "+ i);
...
//		Department[] departments = {sale,marketting,it,security};
//		for (int i =0;i<departments.length -2;i++)
//		{
//			 System.out.println("thong tin phong ban"+" "+departments[i].departmentId);
//			 System.out.println("ten phong ban la" +" "+ departments[i].departmentName);
//		}
...
kết hợp với lệnh break, continue*/
		/*1.Question 10: in ra thông tin các account bao gồm: Email, FullName và tên
...
//		int y = 0;
//		while (y<x) {
//			System.out.println("thong tin cau account thu "+ y);
//			System.out.println(accounts[y].fullName);
//			System.out.println(accounts[y].email);
//			System.out.println(accounts[y].department.departmentName);
//			y++;
...
//				Department[] departments = {sale,marketting,it,security};
//				int y=0;
//				while(y<departments.length)
//				{
//					System.out.println("thong tin department thu "+ y+" " +"la:");
//					System.out.println(departments[y].departmentId);
//					System.out.println(departments[y].departmentName);
//					y++;
//				}
		/*Question 12: Chỉ in ra thông tin 2 department đầu tiên theo định dạng như Question 10*/
//		Department[] departments = {sale,marketting,it,security};
//		int x = departments.length -2;
//		int y = 0;
//		while (y<x)
//		{
//			 System.out.println("thong tin phong ban"+" "+departments[y].departmentId);
//			 System.out.println("ten phong ban la" +" "+ departments[y].departmentName);
//			 y++;}}}
