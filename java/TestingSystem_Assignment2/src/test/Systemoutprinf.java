...
//		System.out.printf("ten toi la: %s và tôi đang độc thân ",hovaten);
...
//				System.out.println(tung.accountID);
//				System.out.println(tung.email);
//				System.out.println(tung.username);
//				System.out.println(tung.fullName);
//				System.out.println(tung.position.positionName);
//				System.out.println(tung.department.departmentName);
//				System.out.println(tung.createDate);
		/*Question 7: in ra danh sách các account đã join group vào ngày nào theo định
		dạng table
//		Date sẽ được định dạng theo format như sau: 24/04/2020 11h:16p:20s*/
...
//				Date date = Date.from(accounts[i].joinDate.atStartOfDay(defaultZoneId1).toInstant());
//				String pattern = "yyyy-MM-dd HH:mm:ss";
//				SimpleDateFormat simpleDateFormat = new SimpleDateFormat(pattern);
//				String date2 = simpleDateFormat.format(accounts[i].joinDate);
